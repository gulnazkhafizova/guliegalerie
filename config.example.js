// CONFIG.EXAMPLE.JS
// Скопируйте этот файл как config.js и замените значения на ваши реальные данные
// ВАЖНО: Добавьте config.js в .gitignore чтобы не публиковать конфиденциальные данные!
